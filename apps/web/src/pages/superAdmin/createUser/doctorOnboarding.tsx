...
const DoctorOnboardingStep1 = () => {
  ...
  const [primarySpeciality, setPrimarySpeciality] = useState<string | null>(
    null,
  );
  ...
  const handlePersonalInfo = () => {
    ...
    const data = {
      bio,
      primarySpeciality,
      specialities: selectedItems.map((item) => item.name),
    };
    console.log(data);
      ...
      >
                  ...
                  >
                    {selectedItems.map((specialty) => (
                      <FormItem
                        ...
                        onChange={() => setPrimarySpeciality(specialty.name)}
                      >
                        <FormControl>
                          <RadioGroupItem {...field} value={specialty.name} />
                        </FormControl>
        ...
        <Button
          ...
          className={`w-full rounded-[15px] px-4 py-2 text-[15px] font-bold leading-[30px] text-white
                      ${disabled ? "bg-gray-400" : "bg-[#0099FF]"}
                    `}
          disabled={disabled}
          onClick={next}
        >
...
const doctorOnboarding = () => {
  ...
  return (
    <section className="mx-[20px] mt-5 lg:mx-[90px] lg:mt-10">
      <h5 className="mb-6 text-[20px] font-semibold leading-[36px] tracking-[0.3px] lg:text-[30px]">
        Doctor Information
      </h5>
      <Steps steps={steps} />
    </section>
